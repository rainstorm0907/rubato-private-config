...
Extract actionable pain points from user feedback. Route validated findings back through the parent frontend UX router for pattern selection.
...
|-----------------|--------------------| ---------|
| **Slow loading** | Skeleton screens, optimistic UI | [State patterns](../../performance-states-patterns/guide.md) |
| **Confusing navigation** | Breadcrumbs, tab navigation, search | [Information architecture](../../information-architecture/guide.md) |
| **Too many steps** | Progressive disclosure, wizards | [Heuristic review](../../nng-ux-heuristics/guide.md) |
| **Can't find features** | Command palette, improved IA | [Information architecture](../../information-architecture/guide.md) |
| **Empty states** | Action-oriented prompts, templates | [State patterns](../../performance-states-patterns/guide.md) |
| **Form errors** | Inline validation, clear messages | [Heuristic review](../../nng-ux-heuristics/guide.md) |
| **Onboarding confusion** | Guided tours, checklist progress | [State patterns](../../performance-states-patterns/guide.md) |
| **Accessibility issues** | WCAG compliance | [Interface guidelines](../../web-interface-guidelines.md) |
| **Visual clutter** | Whitespace, hierarchy, grouping | [Product UI guidance](../../visual-product-ui.md) |
| **Outdated design** | Design system refresh | [Product UI guidance](../../visual-product-ui.md) |
