...
Run the bundled [heuristic evaluation template](../assets/audits/heuristic-evaluation-template.md) internally. Identify the 5 highest-risk areas.
...
- [Product UI guidance](../../visual-product-ui.md) — Design patterns for clearer interfaces
- [Heuristic evaluation template](../assets/audits/heuristic-evaluation-template.md) — Scored audit template
