...
Use this guide to identify problems, opportunities, and evidence that de-risk product decisions. Return to the parent router for implementation guidance.
...
- **UI implementation** → Return to the parent router and use [visual-product-ui.md](../visual-product-ui.md) or the relevant implementation reference
- **Analytics instrumentation** → Use the repository's existing analytics and observability conventions
- **Accessibility compliance audit** → Use accessibility-specific checklists (WCAG conformance)
- **Marketing research** → Use a marketing-specific workflow when one is available
...
- Research plan + output contract using [assets/research-plan-template.md](assets/research-plan-template.md)
...
- [ ] Cross-check material usability risks with the bundled [heuristic guide](../nng-ux-heuristics/guide.md)
