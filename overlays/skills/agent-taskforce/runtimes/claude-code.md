...
| Parallel spawn | several Agent calls in **one** message start at once; calls in separate messages run one behind another. Same rule for the lead spawning teammates and a teammate running subagents |
